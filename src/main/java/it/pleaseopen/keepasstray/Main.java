package it.pleaseopen.keepasstray;

import it.pleaseopen.keepasstray.ui.SearchPanel;
...
public class Main {
    ...
    private static void createAndShowGUI() {
        ...
        final TrayIcon trayIcon =
                new TrayIcon(createImage("poit-icon.png", "tray icon"));
        final SystemTray tray = SystemTray.getSystemTray();

        trayIcon.setToolTip("Please-open.it keepass");
        ...
        trayIcon.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 1) {
                    ...
                    final JFrame popup = new SearchPanel();
